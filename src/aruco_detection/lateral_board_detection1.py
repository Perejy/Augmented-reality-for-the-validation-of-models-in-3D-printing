...
def detect_lateral_aruco_board1(image, cam_matrix, dist_coeffs, marker_length=0.07, refind_strategy=False):
    """
    ...
    obj_points = np.array([
        ...
        [0.18, 0, 0], [0.25, 0, 0], [0.25, 0.07, 0], [0.18, 0.07, 0],  # Esquina superior derecha
    ], dtype=np.float32)
